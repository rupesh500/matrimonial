			...
			<div class="services">
				<div class="col-sm-12 login_left">
					<form action="" method="POST">
						...
						<div class="form-group col-sm-6">
							...
							<input placeholder="abc@mail.com" text" id="edit-name" name="email" value="" size="60" maxlength="60" class="form-text required">
						</div>
					...
					<div class="age_select">
						...
						<div class="age_grid">
							...
							<div class="col-sm-4 form_box2">
								...
								<input placeholder="Caste" type="text" id="edit-name" name="edudescr" value="" size="60" maxlength="60" class="form-text">
							</div>
							<div class="col-sm-4 form_box2">

								<input placeholder="Sub Caste" type="text" id="edit-name" name="edudescr" value="" size="60" maxlength="60" class="form-text">
							</div>
				...
				<div class="form-group col-sm-6">
					<div class="age_select">
						...
						<div class="age_grid">
							<div class="col-sm-4 form_box">
								<input placeholder="India" type="text" id="edit-name" name="fname" value="" size="60" maxlength="60" class="form-text required">
							</div>

							<div class="col-sm-4 form_box2">
								<div class="select-block1">
									<input placeholder="Maharashtra" type="text" id="edit-name" name="fname" value="" size="60" maxlength="60" class="form-text required">
								</div>
							</div>
							<div class="col-sm-4 form_box2">
